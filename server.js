...
app.get("/api/matches", async (req, res) => {
    ...
    try {
        ...
        const data =
            await footballRequest(endpoint);
...
app.listen(PORT, () => {
    ...
    console.log(
        `Goal Zone running on port ${PORT}`
    );
